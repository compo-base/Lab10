...
public class InitApp implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent applicationReadyEvent) {
        ...
        p1=participantRepository.save(Participant.builder().name("Nan").build());
        p2=participantRepository.save(Participant.builder().name("steve").build());
        p3=participantRepository.save(Participant.builder().name("David").build());
        p4=participantRepository.save(Participant.builder().name("Harry").build());
        p5=participantRepository.save(Participant.builder().name("Peter").build());
        ...
        tempEvent.setOrganizer(org1);
        org1.getOwnEvents().add(tempEvent);
        tempEvent.getParticipant().addAll(List.of(p1,p2,p3,p5));
        p1.getEventHistory().add(tempEvent);
        p2.getEventHistory().add(tempEvent);
        p3.getEventHistory().add(tempEvent);
